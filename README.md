...
- **Linguagens & Dados**:  
  ...
  ![Parquet](https://img.shields.io/badge/Apache_Parquet-6666ff?style=for-the-badge&logo=apache&logoColor=white)
...
> **Knowledge in:** Medallion Architecture (Bronze/Silver/Gold) & Dimensional Modeling (Star Schema).

</div>

---

## 🎓 Courses and Certifications | Cursos & Certificações

- ☁️ **Cloud Computing Fundamentals** – IBM SkillsBuild  
- 📊 **Data Analysis and Visualization with Power BI** – Microsoft (Coursera) 
- 🏗️ **Introduction to Data Engineering** – IBM (Coursera)  
